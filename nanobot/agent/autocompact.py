...
class AutoCompact:
    ...
    def _has_compactable_idle_tail(self, key: str) -> bool:
        """Avoid scheduling empty/already archived sessions repeatedly."""
    ...
    def check_expired(
        ...
        resolve_runtime: Callable[[Session], Any] | None = None,
        ...
        for info in self.sessions.list_sessions():
            ...
            if key in active_session_keys:
                continue
            if self._is_expired(info.get("updated_at"), now) and self._has_compactable_idle_tail(key):
                runtime = None
    ...
    async def _archive(self, key: str, *, runtime: Any = None) -> None:
