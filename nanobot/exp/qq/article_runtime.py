...
The preferred path is the Rust RSS sidecar HTTP API. Legacy Python skill scripts
remain as fallback adapters so qq.py does not need to know their command lines.
"""
