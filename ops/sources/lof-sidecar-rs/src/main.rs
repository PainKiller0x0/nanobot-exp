...
(() => {
  ...
  const links = [
    ['驾驶舱','/'],['工作台','/workbench'],['RSS','/rss/'],['LOF','/lof'],['OBP','/obp/'],['任务','/sidecars'],['热点','/trends/'],['收件箱','/inbox'],['Reflexio','/reflexio/']
  ];
