...
```bash
python3 /root/.nanobot/workspace/skills/knowledge-inbox/inbox.py backread "标题关键词或序号" --full
python3 /root/.nanobot/workspace/skills/knowledge-inbox/inbox.py backread-list --limit 8
```
...
- 用户问“补读清单”“明天可补读”，使用 backread-list；用户说“补读 + 标题关键词/序号”，使用 backread --full，默认输出全文并交给渠道分片，不主动截断。
