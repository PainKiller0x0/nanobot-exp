...
RUN apt-get update && \
    apt-get install -y --no-install-recommends curl ca-certificates gnupg git bubblewrap openssh-client tesseract-ocr tesseract-ocr-chi-sim tesseract-ocr-eng && \
